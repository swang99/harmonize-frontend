...
//   const newPostModalDisc = useDisclosure(); // New Post Modal Disclosure
...
//                     <HStack key={`${comment.id}-${comment.author}`} w="100%"> {/* Ensure unique key */}
...
//           <NewPostModal isOpen={newPostModalDisc.isOpen} onClose={newPostModalDisc.onClose} track={postItemData} /> {/* New Post Modal */}
//         </HStack>
//       );
//     } else if (use === 'profile') {
//       return (
...
// import AddTrackToPlaylistModal from './add-track-to-playlist';
// import TrackItem from './track-item';
// import NewPostModal from './NewPostModal'; // Import the new modal
...
//   const addCommentDisc = useDisclosure();
//   const addTrackToPlaylistDisc = useDisclosure();
//   const newPostModalDisc = useDisclosure(); // Disclosure for the new post modal
//   const { fetchOtherProfile, playlists } = useStore((store) => store.profileSlice);
//   const userProfile = useStore((store) => store.profileSlice.currentProfile);
//   const updatePost = useStore((store) => store.postSlice.updatePost);
